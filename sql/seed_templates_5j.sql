-- ============================================================
-- MOMENTUM — Batch 2 : Split 5 jours (8 variantes — Antonin)
-- Source : Cours 1 (splits) + Notion Pierre + cours par muscle
-- Structure Antonin : S1 Pecs / S2 Dos / OFF / S3 Rappel+Épaules / S4 Rappel+Bras / S5 Jambes
-- Volume : 8-12 séries séance principale, 4-6 séries rappel
-- ============================================================
...
BEGIN
  ...
  DELETE FROM training_templates WHERE coach_id = v_coach_id AND category = 'Split 5 jours';

  -- ============================================================
  -- 1. CLASSIQUE
  -- Lundi: Pectoraux | Mardi: Dos | OFF
  -- Jeudi: Épaules | Vendredi: Bras | Samedi: Jambes
  -- (Antonin cours 1 : pecs+tri+delto lat / dos+bi+delto post /
  --  rappel pecs+épaules / rappel dos+bras / jambes)
  -- ============================================================
    ...
    '[
      ...
      },
      {
        ...
        "exercices": [
          ...
          {"nom": "Squat Smith (ou presse à cuisses)", "muscle_principal": "Quadriceps", "sets": [
  ...
  -- OFF | Jeudi: Épaules | Vendredi: Bras | Samedi: Jambes
  -- ============================================================
  INSERT INTO training_templates (nom, coach_id, category, pattern_type, pattern_data, sessions_data)
  VALUES (
    'Split 5j — Focus épaules',
    v_coach_id,
    'Split 5 jours',
    'fixed',
    '{"days": ["Lundi", "Mardi", "Jeudi", "Vendredi", "Samedi"]}',
    '[
      {
        ...
        "exercices": [
          ...
          {"nom": "Élévation latérale machine (rappel delto lat)", "muscle_principal": "Épaules", "sets": [
            {"type": "normal", "reps": "10-15", "tempo": "20X1", "repos": "1m"},
            {"type": "normal", "reps": "10-15", "tempo": "20X1", "repos": "1m"},
            {"type": "normal", "reps": "10-15", "tempo": "20X1", "repos": "1m"}
          ]}
      ...
      },
      {
        ...
        "exercices": [
          ...
          {"nom": "Reverse pec deck (rappel delto post)", "muscle_principal": "Épaules", "sets": [
            {"type": "normal", "reps": "12-15", "tempo": "20X1", "repos": "1m"},
            {"type": "normal", "reps": "12-15", "tempo": "20X1", "repos": "1m"},
            {"type": "normal", "reps": "12-15", "tempo": "20X1", "repos": "1m"}
          ]}
  ...
  -- ============================================================
  -- 3. FOCUS PECTORAUX + ÉPAULES
  -- Lundi: Pecs + delto lat | Mardi: Dos + delto post | OFF
  -- Jeudi: Épaules + pectoraux | Vendredi: Bras | Samedi: Jambes
  -- ============================================================
  INSERT INTO training_templates (nom, coach_id, category, pattern_type, pattern_data, sessions_data)
  VALUES (
    'Split 5j — Focus pectoraux épaules',
    v_coach_id,
    'Split 5 jours',
    'fixed',
    '{"days": ["Lundi", "Mardi", "Jeudi", "Vendredi", "Samedi"]}',
  ...
  -- 4. FOCUS DOS + ÉPAULES
  -- Lundi: Pecs + delto lat | Mardi: Dos + delto post | OFF
  -- Jeudi: Épaules | Vendredi: Dos + Bras | Samedi: Jambes
  -- ============================================================
  INSERT INTO training_templates (nom, coach_id, category, pattern_type, pattern_data, sessions_data)
  VALUES (
    'Split 5j — Focus dos épaules',
    v_coach_id,
    'Split 5 jours',
    'fixed',
    '{"days": ["Lundi", "Mardi", "Jeudi", "Vendredi", "Samedi"]}',
  ...
  RAISE NOTICE '✅ 4 Split 5j templates created (batch 2a — classique + épaules + pecs épaules + dos épaules)';
